...
{
    public class MulOneRuleTests
    {
        [Fact]
        public void MulOneRuleLoadsAndParses()
        {
            ...
            var file = Path.Combine(path, "mul_one.rule");
            Assert.True(File.Exists(file), "mul_one.rule missing");
