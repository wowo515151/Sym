...
namespace SwitchLLM
{
    public class LLM
    {
        ...
        public static string DefaultModelDescription = "OpenRouter,stepfun/step-3.5-flash:free,$0.0,$0.0,262000,262000,stepfun/fp8".Trim();
        public static string DefaultSearchModelDescription = "Local,openai/gpt-oss-20b".Trim();
...
OpenRouter,stepfun/step-3.5-flash:free,$0.0,$0.0,262000,262000,stepfun/fp8
";
